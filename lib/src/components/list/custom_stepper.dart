...
/// Defines the [StepperX]'s main axis.
enum StepperType {
...
/// Container for all the information necessary to build a StepperX widget's
/// forward and backward controls for any given step.
///
/// Used by [StepperX.controlsBuilder].
@immutable
class ControlsDetailsX {
  /// Creates a set of details describing the StepperX.
  const ControlsDetailsX({
  ...
  /// Index that is active for the surrounding [StepperX] widget. This may be
  ...
  /// just activated the transition to a new step, some [StepperX.type] values will
...
typedef ControlsWidgetBuilder = Widget Function(
    BuildContext context, ControlsDetailsX details);
...
/// A material step used in [StepperX]. The step can have a title and subtitle,
...
///
/// {@tool dartpad}
/// An example the shows how to use the [StepperX], and the [StepperX] UI
/// appearance.
///
...
///
///  * [StepX]
class StepperX extends StatefulWidget {
  ...
  final List<StepX> steps;
  final Color? cirColor;

  Color get circColor {
    return cirColor != null ? circColor : Colors.black;
  }
  ...
  @override
  State<StepperX> createState() => _StepperState();
}

class _StepperState extends State<StepperX> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(StepperX oldWidget) {
  ...
  Widget _buildVerticalControls(int stepIndex) {
    ...
    return Container(
      ...
      child: ConstrainedBox(
        ...
        child: Row(
          // The Material spec no longer includes a StepperX widget. The continue
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<StepperX>() != null) {
        throw FlutterError(
